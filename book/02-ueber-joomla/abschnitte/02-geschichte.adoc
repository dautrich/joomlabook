...
Mit Version 4.0 änderte sich vieles: Es gab ein nahezu vollständiges 
internes Redesign, eine erneut überarbeitete Administrationsoberfläche, 
höhere Mindestanforderungen an die Systemumgebung sowie eine neue Struktur
...
wurde jetzt eine neue Release-Strategie eingeführt; doch dazu später 
mehr.

Entsprechend dieser neuen Strategie wurden die Hauptversionen 5.0 im 
Oktober 2023 und 6.0 im Oktober 2025 wie vorgesehen veröffentlicht.
