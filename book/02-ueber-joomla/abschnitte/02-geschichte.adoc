...
Mit Version 4.0 änderte sich vieles: Es gab ein nahezu vollständiges internes Redesign, eine erneut überarbeitete Administrationsoberfläche, höhere Mindestanforderungen an die Systemumgebung sowie eine neue Struktur
