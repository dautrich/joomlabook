namespace :book do
  ...
  task :build_html => 'book/contributors.txt' do
      ...
      sh "bundle exec asciidoctor #{params} -a data-uri joomla-de.adoc"
      puts ' -- HTML output at joomla-de.html'
  ...
  task :build_epub => 'book/contributors.txt' do
      ...
      sh "bundle exec asciidoctor-epub3 #{params} joomla-de.adoc"
      puts ' -- Epub output at joomla-de.epub'
  ...
  task :build_fb2 => 'book/contributors.txt' do
      ...
      sh "bundle exec asciidoctor-fb2 #{params} joomla-de.adoc"
      puts ' -- FB2 output at joomla-de.fb2.zip'
  ...
  task :build_mobi => 'book/contributors.txt' do
      ...
      sh "bundle exec asciidoctor-epub3 #{params} -a ebook-format=kf8 joomla-de.adoc"
      puts " -- Mobi output at joomla-de.mobi"
  end
  ...
  task :build_pdf => 'book/contributors.txt' do
      ...
      sh "bundle exec asciidoctor-pdf #{params} joomla-de.adoc 2>/dev/null"
      puts ' -- PDF output at joomla-de.pdf'
  end
  ...
  task :check => [:build_html, :build_epub] do
      ...
      sh "htmlproofer joomla-de.html"
      sh "epubcheck joomla-de.epub"
  end
